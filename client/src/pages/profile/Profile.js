      ...
      try{
        if(profileImg !== null && (
          ...
          profileImg.type === "image/png")){
            ...
            const response = await fetch("https://api.cloudinary.com/v1_1/blazejay/image/upload", {method: "POST", body:image})
          ...
          <Card cardClass={"card"}>
            <>
              <div className="profile-photo">
                <div>
                  <img src={imagePreview === null ? user?.photo : imagePreview} alt="profile pic" />
